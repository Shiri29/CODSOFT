...
public class CurrencyConverter extends JFrame {
    ...
    public CurrencyConverter() {
        ...
        // Complete exchange rates for all pairs
    ...
    private void convertCurrency() {
        try {
            ...
            // Round both values to whole number
            long roundedAmount = Math.round(amount);
            long roundedConverted = Math.round(converted);

            String baseSymbol = currencySymbols.getOrDefault(base, "");
            String targetSymbol = currencySymbols.getOrDefault(target, "");

            resultLabel.setText(String.format("%s%d = %s%d",
                    baseSymbol, roundedAmount,
                    targetSymbol, roundedConverted));
